...
export const CommandForm = ({ onSendCommand, isConnected }: CommandFormProps) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/10 hover:border-white/20 transition-all duration-300">
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm">Enter a key-value pair to store in your Redis cache</p>
      </div>
