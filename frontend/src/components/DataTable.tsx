          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/5 bg-white/5">
                <th className="p-6 text-left text-sm font-semibold text-slate-300 uppercase tracking-wider">
                  Key
                </th>
                <th className="p-6 text-left text-sm font-semibold text-slate-300 uppercase tracking-wider">
                  Value
                </th>
                <th className="p-6 text-right text-sm font-semibold text-slate-300 uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
